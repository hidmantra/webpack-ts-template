...
export class GalleryStripModal {
    ...
    public appendComponent(targetComponent: JQuery): void {
        ...
        let titleElement: JQuery = $("<div class='medium-holder'><h5 class='medium-title'>" + this._gsm_vo.componentTitle + "</h5></div>");
        ...
        holderElement.id = "grid-holder";
        let gridRow: JQuery = $("<div id='thumb-row' class='row'></div>");
